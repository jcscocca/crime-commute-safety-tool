...
export const METHODS_DEFINITIONS: MethodDefinition[] = [
  ...
  { id: "beatBaselineRate", term: "Surrounding-area baseline", shownAs: "Beats M2 + M1 + D1",
    plain: "Every SPD police beat your search radius touches (2018-present), pooled, EXCLUDING the area inside the radius itself — the 'normal for this area' reference. With a small radius inside one beat this is simply the rest of that beat. The same filters apply.",
